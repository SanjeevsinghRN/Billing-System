...
/// <summary>
/// This class is used to compress the image to provided size
/// </summary>
public class ImageCompress
{
    ...
    private bool ISValidFileType(string fileName)
    {
        ...
        {
            case ValidImageFileTypes.JPEG:
            case ValidImageFileTypes.BTM:
            case ValidImageFileTypes.JPG:
            case ValidImageFileTypes.PNG:
                isValidExt = true;
                break;
        }
        return isValidExt;
...
public class ValidImageFileTypes
{
